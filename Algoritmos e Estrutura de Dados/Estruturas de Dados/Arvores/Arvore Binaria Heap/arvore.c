...
// ARVORE HEAP É BINÁRIA E OBSERVA OS CONCEITOS DE ORDEM E DE FORMA.
// Ordem: o nó deve satisfazer uma relação de ordem com os itens dos nós filhos
//      - Heap máximo (ou descendente): pai >= filhos, sendo a raiz maior elemento.
//      - Heap mínimo (ou ascendente): pai <= filhos, sendo a raiz o menor elemento.
// Forma: a árvore binária tem seus nós folha em no máximo dois níveis - o que, em
//      outras palavras, significa que somente o último nível pode estar incompleto.
//      Além disso, as folhas devem estar o mais à esquerda possível.
//
// Remoção de Itens: a prática recomenda substituir o elemento removido pelo último
// elemento inserido. Logo em seguida, deve-se ordenar a árvore, escolhendo-se o maior
// elemento filho.
