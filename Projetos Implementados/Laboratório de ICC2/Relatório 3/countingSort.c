...
/*
	...
	Algoritmo estável:
	Entrada: [1' 5' 0' 0'' 5'' 1'' 2 5''' 3 1''']
	Saída:   [0' 0'' 1' 1'' 1''' 2 3 5' 5'' 5''']
	
	- 1) Cópia completa dos dados originais.
	- 2) Alocação de memória: (referência das chaves a serem ordenadas)
		2.1) Percorrer as chaves e verificar o mínimo e máximo (mínimo = 0; máximo = 5) -> amplitude
		2.2) Criação de um vetor adicional de contagem: (maximo-minimo+1)
			[0 0 0 0 0 0] 
		2.3) Percorrer o vetor de entrada com o somatório por chave:
			[2 3 1 1 0 3]
