/*
    Precisa debuggar as funções SMALL e BIG. Analisei sinal. Precisa analisar tamanho.
    Por fim, precisa comparar os algarismos da esquerda para a direita.

    Outro ponto que pode estar errado é a soma de numeros positivos com negativos.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int small(numero *n1, numero *n2){
    ...
    if ((n1->sinal == 'n') && (n2->sinal == 'p')){return 1;}
    else if ((n1->sinal == 'p') && (n2->sinal == 'n')){return 0;}
    else{
        while(saida == 0){
            if ((auxiliarN1 == NULL) && (auxiliarN2 == NULL)){break;}
